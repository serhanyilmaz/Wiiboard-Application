...
public class SurveyService extends Service {
    ...
    public void bildirimGonder(){// Burda servis class dan post edip sunucudan aldığımız değeri bildirim gönderiyoruz.
        ...
        for (int i = 0; i < wifiList.size(); i++) {
            ...
            if(i == wifiList.size()-1 && !wifiList.get(i).SSID.equalsIgnoreCase(getResources().getString(R.string.wifi_name))  )
            {
          ...
          else  if (wifiList.get(i).SSID.equalsIgnoreCase(getResources().getString(R.string.wifi_name))  ) {
    ...
    public class NotifyServiceReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context arg0, Intent arg1) {
            ...
            Intent serviceIntent = new Intent(context, SurveyService.class);
